...
>(({ className, ...props }, ref) => (
    <div className={cn('absolute ltr:left-0 rtl:right-0 top-full flex justify-center')}>
...
>(({ className, ...props }, ref) => (
    <NavigationMenuPrimitive.Indicator
        ...
        {...props}
    >
        <div className="bg-border relative top-[60%] h-2 w-2 rotate-45 ltr:rounded-tl-sm rtl:rounded-tr-sm shadow-md" />
    </NavigationMenuPrimitive.Indicator>
));
